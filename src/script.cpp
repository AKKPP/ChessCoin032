...
bool CheckLockTimeForBIP65(const CTransaction* txTo, unsigned int nIn, const CScriptNum& nLockTime)
{
...
bool CheckSequenceForBIP65(const CTransaction* txTo, unsigned int nIn, const CScriptNum& nSequence)
{
