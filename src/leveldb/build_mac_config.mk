...
PLATFORM_LDFLAGS=
PLATFORM_LIBS=
PLATFORM_CCFLAGS= -std=gnu++14 -fno-builtin-memcmp -pthread -DOS_MACOSX -DLEVELDB_PLATFORM_POSIX -arch=x86_64
PLATFORM_CXXFLAGS= -std=gnu++14 -fno-builtin-memcmp -pthread -DOS_MACOSX -DLEVELDB_PLATFORM_POSIX -arch=x86_64
